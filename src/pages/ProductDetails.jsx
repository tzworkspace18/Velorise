        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="flex gap-4 flex-col md:flex-row">
            ...
            <div className="block md:hidden">
              <div className="flex items-center justify-center border border-gray-100 p-4 mb-3">
                <img
                  src={mainImage}
                  alt={product.name}
              ...
              <div className="flex justify-center gap-3">
                {product.images.slice(0, 3).map((img, i) => (
                  <img
                    ...
                    className={`w-20 h-24 border rounded-md object-cover cursor-pointer ${
                      mainImage === img
                        ? "border-gray-900"
          ...
          <div className="flex flex-col">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-3">
                {["black", "white", "blue", "red", "green", "brown"].map(
                  (color) => (
                    <button
                      key={color}
            ...
            <div className="flex flex-row items-center justify-between gap-3 mb-6">
              <button
                ...
                className={`flex items-center justify-center gap-2 border border-gray-300 px-4 py-3 flex-1 text-sm font-medium rounded-md ${
              ...
              <button
                ...
                className="flex-1 bg-black text-white font-semibold py-3 text-sm rounded-md hover:bg-gray-800 transition"
              >
                Add to Bag
              </button>
            </div>

            {/* ✅ Delivery Info — Equal Top & Bottom Padding */}
            <div className="border-t border-gray-200 pt-6 pb-0 grid grid-cols-3 gap-3 text-center text-sm text-gray-700">
